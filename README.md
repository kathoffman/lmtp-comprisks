...
SETS FOR TREATMENT AND OUTCOME REGRESSIONS AND USES SL3.**
...
``` r
library(lmtp, lib = "~/Desktop/lmtp-alternates/2covarSets-sl3")
#> NOT MAIN VERSION OF LMTP! THIS VERSION IMPLEMENTS DIFFERENTS COVARIATE SETS FOR TREATMENT AND OUTCOME REGRESSIONS AND USES SL3.
